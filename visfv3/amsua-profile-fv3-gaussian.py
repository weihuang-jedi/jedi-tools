...
#=======================================================================================================================
  ...
  gsi_data_dir = '/work/noaa/gsienkf/weihuang/jedi/case_study/amsua/jeff-data'

  gsi_bkg = '%s/sfg_2021010900_fhr06_ensmean' %(gsi_data_dir)
  gsi_anl = '%s/sanl_2021010900_fhr06_ensmean' %(gsi_data_dir)

  datadir = '/work/noaa/gsienkf/weihuang/jedi/case_study/amsua/analysis.reasonable/increment/'
...
#=======================================================================================================================
  ...
  with open('amsua_profile_data.txt', 'w') as f:
    f.write('%d, %d, %d\n' %(nz, ny, nx))
    for i in range(nz):
