...
#=========================================================================
with open('amsua_profile_data.txt', 'r') as filehandle:
 ...
 #plt.title('New uv Only Sqrt(Mean(GSI^2)), Sqrt(Mean((JEDI)^2)) and Sqrt(Mean((GSI-JEDI)^2))', fontsize=10)
  plt.title('AMSUA Sqrt(Mean(GSI^2)), Sqrt(Mean((JEDI)^2)) and Sqrt(Mean((GSI-JEDI)^2))', fontsize=10)
 ...
 #plt.xlim((0, 200.0))
  ...
  plt.title('AMSUA Rate of Sqrt(Mean((GSI-JEDI)^2)/Mean(GSI^2))', fontsize=14)
  plt.xlabel('%', fontsize=14)
  plt.ylabel('Level', fontsize=14)
  plt.grid(True)

 #plt.show()
  plt.savefig('amsua_rate.png')
