  ...
  def writedata(self):
   #---------------------------------------------------------------------------------------------
    ...
    for k in range(nobs):
     ...
     #   sys.exit(-1)
      ...
      infostr = '%s %f, %f,' %(infostr, self.gsiinfo['obs'][n], self.jediinfo['obs'][i])
   ...
   #---------------------------------------------------------------------------------------------
    ...
    for k in range(nobs):
      ...
      infostr = '%f, %f, %f,' %(self.gsilat[n], self.gsilon[n], self.gsiinfo['obs'][n])
      gsihofx = self.gsiinfo['obs'][n] - self.gsiinfo['omb'][n]
   ...
   #---------------------------------------------------------------------------------------------
    ...
    for k in range(nobs):
      ...
      infostr = '%s %f,' %(infostr, self.jediinfo['obs'][i])
