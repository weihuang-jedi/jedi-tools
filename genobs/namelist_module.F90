...
MODULE namelist_module
  ...
  integer                 :: numobs
  real, dimension(maxobs) :: lat, lon, prs, tmp, sfp, omb, obserr
...
contains
  subroutine read_namelist(file_path)
    ...
    sfp = (/101123.06, 101234.78, 101345.18,  101456.09,  101567.47,  101678.43,  101789.71/)
    ...
    skipvars(5) = 'air_temperature'

!   skipvars(5) = 'surface_pressure'
!   keptvars(1) = 'air_temperature'

    numkeptvars = 1
    keptvars(1) = 'surface_pressure'

    do i = 1, maxobs
      LaunchTime(i) = '2020-01-10T06:00:00Z'
    end do
