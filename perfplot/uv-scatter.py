...
#m.barbs(lon[::200], lat[::200], u[::200], v[::200], pivot='middle', barbcolor='#333333')
#m.barbs(lon[::200], lat[::200], u[::200], v[::200], pivot='middle', barbcolor='blue')
speed = np.sqrt(u*u + v*v)
#m.quiver(lon[::200], lat[::200], u[::200], v[::200], speed[::200], cmap=plt.cm.autumn)
m.quiver(lon[::200], lat[::200], u[::200], v[::200], speed[::200], cmap=plt.cm.autumn,
  scale_units='height', scale=200.0, headlength=5, headwidth=3, headaxislength=4, alpha=0.75)
