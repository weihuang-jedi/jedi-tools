...
#------------------------------------------------------------------------------
  ...
  image_prefix = 'JEDI_temperature_increment4surfacePressureOnly'
  title_preix = 'JEDI Temperature increment4surfacePressureOnly at'
 ...
 #------------------------------------------------------------------------------
  ...
  for lev in levs:
    ...
    if(addobs):
     ...
     #pt.plot(pvar, addmark=1, marker='+', size=20, color='cyan')
      pt.plot(pvar, addmark=1, marker='+', size=1, color='cyan')
    else:
      pt.plot(pvar)
