...
if __name__ == '__main__':
  debug = 1
  wgtdir = 'grids/'
  outdir = '/work/noaa/gsienkf/weihuang/jedi/case_study/bump/latlondata'
 ...
 #generate weight file if needed.
  ...
  nemsrc = '/work2/noaa/gsienkf/weihuang/data/UFSRNR_GSI_SOCA_LETKF_COUPLED_012016_FROLOV_IAU/20160111060000/intercom/forecast'
  ...
  for n in range(1, 81):
    infile = '%s/mem%03d/bkgrd/MOM.res.2016-01-11-12-00-00.nc' %(nemsrc, n)
    print('Processing:', infile)
    outfile = '%s/ocean_ens1_%06d.nc' %(outdir, n)
