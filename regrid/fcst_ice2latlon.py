...
if __name__ == '__main__':
 ...
 #generate weight file if needed.
  ...
  icesrc = '/work2/noaa/gsienkf/weihuang/data/UFSRNR_GSI_SOCA_LETKF_COUPLED_012016_FROLOV_IAU/20160111060000/intercom/forecast'
  for n in range(1, 81):
    infile = '%s/mem%03d/bkgrd/CICE.res.2016-01-11-12-00-00.nc' %(icesrc, n)
    print('Processing:', infile)
    outfile = '%s/ice_ens1_%06d.nc' %(outdir, n)
